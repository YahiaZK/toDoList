...
const deleteTask = (taskElement, taskObject) => {
  ...
  deleteBtn.addEventListener("click", (e) => {
    e.preventDefault();
    allTasksArray = allTasksArray.filter((task) => task.id !== taskObject.id);
    saveTasks();
    createTasksList();
  });
};
...
const showPopupDeleteAll = (popupText, popupTitle) => {
...
const showPopupDeleteDone = (popupText, popupTitle) => {
